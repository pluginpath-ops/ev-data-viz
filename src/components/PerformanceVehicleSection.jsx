...
export default function PerformanceVehicleSection({ vehicle, canEdit }) {
    ...
    return (
        <div className="mt-6">
            ...
            {!loaded ? (
                <p className="text-sm text-secondary mb-2">Loading…</p>
            ) : sessions.length === 0 ? (
            ...
            {/* ── Published results ──────────────────────────────────────── */}
            <div className="text-meta text-[10px] uppercase tracking-wide mt-4 mb-1 font-semibold">
                Published results
            </div>
            {summaries.length === 0 ? (
                <p className="text-sm text-secondary mb-2">
                    ...
                    <div className="flex flex-wrap items-end gap-2">
                        ...
                        <label className="text-xs">
                            ...
                            <input
                                ...
                                className="form-input form-input w-48"
                            />
                        </label>
                    </div>
