        ...
        specimens: [
            ...
            { composite: 'series-color-picker', label: 'Series colour picker (live)',
              covers: ['popover-anchor', 'popover-foot', 'series-swatch--button',
                       'color-picker-body', 'color-slots', 'color-slot', 'color-custom',
                       'color-custom-hex', 'color-note'],
              note: 'The one live specimen on this page, because a picker is a mechanism rather than an appearance. It replaced five <input type="color"> boxes: an OS dialog, one colour at a time, with no view of the set you are picking against — and no way to say that Auto Color is drawing something other than what is saved. Palette is Okabe-Ito, the same set resolveChartColors assigns from. Cancel, ×, Escape and an outside click all discard; only Apply writes.' },
